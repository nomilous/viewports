...
define("../node_modules/requirejs-middleware/almond", function(){});
  ...
  return service = {
    init: function(config) {
      ...
      service.socket.on('connect', function() {
        ...
        return service.socket.emit('viewport:connect', {
          group: service.group
        });
      });
      service.socket.on('viewport:connect:ok', function(data) {
        return console.log('viewport:connect:ok', data);
      });
      return {
    ...
    emit: function(event, data) {
      return service.socket.emit(event, data);
    },
    on: function(event, cb) {
      return service.socket.on(event, cb);
    }
  };
});
...
define('input/keyboard',[],function() {
  ...
  return service = {
    init: function(config) {
      ...
      document.addEventListener('keydown', service.onEvent, false);
      return document.addEventListener('keyup', service.onEvent, false);
    },
    include: function(e) {
      return {
        type: e.type,
...
define('controls',['./input/keyboard', './input/mouse'], function(keyboard, mouse) {
  return {
    init: function(config) {
      keyboard.init(config);
      mouse.init(config);
      config.uplink.on('viewport:event', function(data) {
...
require(['./uplink', './view', './controls'], function(uplink, view, controls) {
  var Viewport;
